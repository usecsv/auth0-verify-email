...
import { Center, VStack, Text, Divider, Box, Button, ChakraProvider } from '@chakra-ui/react';
...
var VerifyYourAccount = function (_a) {
    ...
    return (React.createElement(Center, { h: "90vh", m: "auto" },
        React.createElement(VStack, { align: "center", w: "40vw", textAlign: "center", spacing: 8 },
            React.createElement(Text, { fontSize: "2xl" }, "Almost there \u2026"),
            ...
            React.createElement(Text, null,
                ...
                " ",
                React.createElement(Box, { display: "contents", textDecoration: "underline", color: "blue", cursor: "pointer", onClick: function () { return logout(); } }, "click here to go back"),
                " ",
                "and enter the correct one.",
                " "),
            React.createElement(Text, null, "If you have not received our email in 15 minutes, please check your spam folder."),
            React.createElement(VStack, null,
                React.createElement(Text, null, "Still can't find it?"),
                !toManyReq && (React.createElement(Button, { onClick: function () {
                ...
                !loading && called && (React.createElement(Text, { color: error ? "warning.600" : "secondary.500" }, error ? errorMsg : "Your verification email has been sent, please check your inbox.")),
                seconds > 0 && React.createElement(Text, { fontSize: "xs" },
...
export { CheckEmailVerification, EmailVerifiedNextPage, sendVerificationEmailHandler };
//# sourceMappingURL=auth0-verify-email.esm.js.map
